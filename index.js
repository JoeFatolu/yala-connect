...
function connect({ key, onClose = anonFunc, onSuccess, onLoad = anonFunc, onEvent = anonFunc, ...rest }) {
  ...
  this.bankId = bankId || isRequired("BANK_ID");
  this.customerId = customerId || isRequired("CUSTOMER_ID");
  this.config = { ...rest };
